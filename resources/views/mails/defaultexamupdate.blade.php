<head>
    ...
    <title>An exam you're assigned to has been modified</title>
    <style type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">
        ...
        <td width="100%" valign="top" style="padding-top:0px;margin:0;border:0;vertical-align: top;">
            ...
            <div class="mobile-hidden">
                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td style="font-size: 20px;background: #000d35;color:#fff;padding-top:10px;padding-bottom:10px" align="center">
                            Invigil8
                        </td>
                    </tr>
                    </tbody>
    ...
    <tr>
        <td width="100%" valign="top" style="padding-top:0px;margin:0;border:0;vertical-align: top;">
            ...
            <div class="mobile-hidden">
                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#f2f2f2">
                    <tbody>
                    <tr>
                        <td style="min-width: 600px"></td>
                    </tr>
                    <tr>
                        <td style="font-size: 18px;background: #f2f2f2; padding: 0px 0px 0px 0px;color:#555;font-weight:bold;padding: 10px;padding-top: 40px;padding-left: 50px;padding-right: 50px;" align="center">
                            Hello {{ @$demo->firstname }}, an exam you're assigned to has been modified. Here are the changes...
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 0;background: #f2f2f2; width: 552px; padding:24px 24px 32px;" align="center">
                            <p style="margin-bottom: 20px;line-height:28px;font-family: Arial Regular, sans-serif; font-size: 14px; letter-spacing:0.8px; color: #555;">
                                <span style="color: #555;">Here are the details of the exam:</span>
                                <br>
                            ...
                            <b style="line-height:28px;font-family: Arial Regular, sans-serif; font-size: 14px; letter-spacing:0.8px; color: #555;">Original:</b>
                            ...
                            <br>
                            <br>
                            <b style="line-height:28px;font-family: Arial Regular, sans-serif; font-size: 14px; letter-spacing:0.8px; color: #555;">Changes:</b>
                            <p style="line-height:28px;font-family: Arial Regular, sans-serif; font-size: 14px; letter-spacing:0.8px; color: #990000;text-align: left;" align="left">
                                {!! @$demo->changes !!}
                            </p>
                        </td>
        ...
        <td width="100%" valign="top" style="padding-top:0px;margin:0;border:0;vertical-align: top;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mobile-hidden">
                                ...
                                <tr>
                                    ...
                                    <td width="360" style="font-size:0pt;" align="center">
                                        <div class="text-footer" style="color:#555; font-family:Arial; font-size:12px; line-height:22px; text-align:center;width:360px">
                                            <a href="{{ route('home') }}" class="link-footer" style="color:#605f5d; text-decoration:none" target="_blank"><span class="link-footer" style="color:#d8d8d8; text-decoration:none">Invigil8</span></a>                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://www.headspace.com/how-it-works?utm_source=trialist&amp;utm_medium=email&amp;utm_content=SleepAM&amp;utm_campaign=2017Sleep" class="link-footer"



                                        <div class="link-footer linkColor" style="color:#555; font-family:Arial; font-size:10px; line-height:12px; text-align:center;width:360px">
                                            You have received this email as a registered user of
                                            <a href="{{ route('home') }}" class="link-footer" style="color:#aaaaaa; text-decoration:none" target="_blank">
                                                <strong class="link-footer" style="color:#555; text-decoration:none">Invigil8</strong></a><br>
                                            You can unsubscribe at any time by clicking the unsubscribe link in this email.
                                        </div>
            ...
            <div class="desktop-hidden" style="max-height: 0px; overflow:hidden; display:none;">
                <table width="600" cellpadding="0" cellspacing="0" align="center" class="desktop-hidden deviceWidth mobile-bg" padding="0" margin="0" border="0" style="max-height: 0px; overflow:hidden; display:none; margin-left:auto; margin-right:auto; width:0px">
                    ...
                    <tr>
                        <td align="center">
                            <table width="80%" border="0" cellspacing="0" cellpadding="0" class="desktop-hidden deviceWidth mobile-bg" style="max-height: 0px; overflow:hidden; display:none; margin-left:auto; margin-right:auto; width:0px">
                                <tbody>
                                <tr>
                                    <td align="center" style="font-size: 14px;" bgcolor="#ffffff">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                            <tr>
                                                <td width="310" style="font-size:0pt;" align="center">
                                                    <div class="text-footer" style="color:#555; font-family:Arial; font-size:12px; line-height:22px; text-align:center;width:310px">
                                                        <a href="{{ route('home') }}" class="link-footer" style="color:#605f5d; text-decoration:none" target="_blank"><span class="link-footer" style="color:#d8d8d8; text-decoration:none">Invigil8</span></a>                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://www.headspace.com/how-it-works?utm_source=trialist&amp;utm_medium=email&amp;utm_content=SleepAM&amp;utm_campaign=2017Sleep" class="link-footer"
