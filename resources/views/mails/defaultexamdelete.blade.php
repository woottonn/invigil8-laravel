<head>
    ...
    <title>An exam you were assigned to has been deleted</title>
    <style type="text/css">
        ...
        <td width="100%" valign="top" style="padding-top:0px;margin:0;border:0;vertical-align: top;">
            ...
            <div class="mobile-hidden">
                <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile-hidden" bgcolor="#f2f2f2">
                    ...
                    <tr>
                        <td style="font-size: 18px;background: #f2f2f2; padding: 0px 0px 0px 0px;color:#555;font-weight:bold;padding-top:40px;padding-left: 50px;padding-right: 50px;" align="center">
                            Hello {{ @$demo->firstname }}, an exam you were assigned to has been removed...
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 0;background: #f2f2f2; width: 552px; padding:24px 24px 32px;" align="center">
                            <p style="margin-bottom: 20px;line-height:28px;font-family: Arial Regular, sans-serif; font-size: 16px; letter-spacing:0.8px; color: #555;">
